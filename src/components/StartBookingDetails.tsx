...
function StartBookingDetails() {
    ...
    useEffect(() => {
        ...
        console.log(contextState.movingServiceForm.productId)
    }, []);
    ...
    return (
        <div className={"ms-container"}>
            ...
            <div className="ms-step-nav">
                ...
                {/*<button type="button" className="ms-button" onClick={onBookingRequest}>Booking Request</button>*/}
            </div>
        </div>
    );
}

export default StartBookingDetails;
